...
def render_career_pathways():
	...
	st.subheader("What is an Apprenticeship?")
	st.write("Apprenticeships combine paid on-the-job training with classroom instruction to prepare workers for highly-skilled careers.")
	st.write("Workers benefit from apprenticeships by receiving a skills-based education that prepares them for good-paying jobs. Apprenticeship programs help employers recruit, build, and retain a highly-skilled workforce.")
